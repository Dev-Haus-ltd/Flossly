<template>
  ...
  >
    ...
    <div class="automation-desc">{{ description }}</div>
...
<style scoped>
.automation-card { border:1px solid #dfdfdf; padding:16px; cursor:pointer; transition: all .2s ease; min-height: 240px; }
...
.automation-title { font-weight:600; font-size:14px; margin-bottom:6px; }
.automation-desc { font-size:12px; color:#636363; min-height:40px; }
