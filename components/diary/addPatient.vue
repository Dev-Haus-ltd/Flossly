      ...
      <v-card class="pa-4" color="white" elevation="0">
        <v-form ref="formRef">
          <v-row dense>
            ...
            <v-col cols="12" sm="6">
              <label class="fld-lbl"
                >Biological Sex <span class="req">*</span></label
              >
              <v-select
                v-model="form.sex"
                :items="sexes"
            ...
            <v-col cols="12" sm="6">
              ...
              >
                ...
                <v-date-picker
                  v-model="form.dob"
                  @update:modelValue="dobMenu = false"
                />
              </v-menu>
            </v-col>
            <v-col cols="12" sm="6">
            ...
            <v-col cols="12" sm="6">
              ...
              <v-select
                v-model="form.recallInterval"
                :items="recallIntervals"
                variant="solo"
                density="compact"
                class="input-bordered mb-0"
                bg-color="white"
...
const dobFormatted = computed(() =>
  form.dob ? formatDateDDMMYYYY(form.dob) : "",
);
const drawerTitle = computed(() =>
  props.patient?.id ? "Edit Patient" : "Add New Patient",
);
