          ...
          <template v-else>
            <div class="mh-stats-bar">
              ...
              <div v-if="typeof data?.totalInstagramAccounts !== 'undefined'" class="mh-stat">
                ...
                <div class="mh-stat__val mh-stat__val--ig">
                  <v-icon size="11" color="#E1306C">mdi-instagram</v-icon>
                  {{ data?.totalInstagramAccounts || 0 }}
                </div>
              </div>
            </div>
                ...
                >
                  <div class="mh-page-row__main">
                    ...
                    <div class="mh-page-row__chips">
                      ...
                      <!-- Instagram connection — always shown, no typeof guard -->
                      <v-chip
                        size="x-small"
                        :color="page.instagramConnected ? 'success' : 'warning'"
                        variant="tonal"
                        label
                      >
                        <v-icon start size="11">mdi-instagram</v-icon>
                        {{ page.instagramConnected ? 'IG Connected' : 'IG Not linked' }}
                      </v-chip>
                    ...
                    <div
                      ...
                      class="mh-page-row__meta mh-page-row__meta--ig"
                    >
                      <v-icon size="11" color="#E1306C">mdi-instagram</v-icon>
