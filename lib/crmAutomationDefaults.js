export const crmAutomationDefaults = [
  ...
  },
  {
    ...
    subject: 'Thanks for Reaching Out to [Practice Name]!',
  ...
  },
  {
    ...
    subject: 'Are you ready to Transform Your smile?',
    sending: '3 days after enquiry',
    enabled: false,
    trigger: { type: 'inquiry_days', days: 3 },
  ...
  },
  {
    ...
    subject: "Don't Miss Out on Exceptional Dental Care",
  ...
  },
  {
    ...
    subject: 'Unlock your dream smile with us!',
    sending: '1 day after enquiry',
    enabled: false,
    trigger: { type: 'inquiry_days', days: 1 },
  ...
  },
  {
    ...
    subject: 'Composite Bonding FAQs Answered',
    sending: '3 days after enquiry',
    enabled: false,
    trigger: { type: 'inquiry_days', days: 3 },
  ...
  },
  {
    ...
    subject: 'Special Offer on Composite Bonding This Month',
    sending: '5 days after enquiry',
    enabled: false,
    trigger: { type: 'inquiry_days', days: 5 },
  ...
  },
  {
    ...
    subject: "Your Dream smile in 12 months or less, yes, it's possible!",
    sending: '1 day after enquiry',
    enabled: false,
    trigger: { type: 'inquiry_days', days: 1 },
  ...
  },
  {
    ...
    subject: 'How Invisalign Can Fit Your Lifestyle',
    sending: '3 days after enquiry',
    enabled: false,
    trigger: { type: 'inquiry_days', days: 3 },
  ...
  },
  {
    ...
    subject: 'Limited Slots Left On Our Aligner Promotion',
    sending: '5 days after enquiry',
    enabled: false,
    trigger: { type: 'inquiry_days', days: 5 },
  ...
  },
  {
    ...
    subject: 'Stay Healthy with a Comprehensive Dental Check-Up',
    sending: '1 day after enquiry',
    enabled: false,
    trigger: { type: 'inquiry_days', days: 1 },
  ...
  },
  {
    ...
    subject: 'What to Expect at Your Check-Up',
    sending: '3 days after enquiry',
    enabled: false,
    trigger: { type: 'inquiry_days', days: 3 },
  ...
  },
  {
    ...
    subject: 'Book Your Check-Up Today & Receive a Free Dental Care Kit',
    sending: '5 days after enquiry',
    enabled: false,
    trigger: { type: 'inquiry_days', days: 5 },
  ...
  },
  {
    ...
    subject: 'Black Friday - Last Chance',
